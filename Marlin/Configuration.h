 ...
 */
#define BLTOUCH
#define SERVO0_PIN 27 // bltouch will use the LCD 27 pin via an expension board
...
//
// extra important to disable SPEAKER for BLT 
// (if using pin 27 for BLT and not SPEAKER)
// #define SPEAKER
